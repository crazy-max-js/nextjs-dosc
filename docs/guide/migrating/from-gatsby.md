...
Instead, use the built-in[`next/image`](/docs/guide/api-reference/next/image)component and[Automatic Image Optimization](/docs/guide/basic-features/image-optimization).
